...
const CreateQuote = () => {
  ...
  const handleSave = () => {
    // Validation
    if (!clientName.trim()) {
      toast.error("Inserisci il nome/ragione sociale del cliente");
      return;
    }
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          ...
          >
            <h2 className="text-xl font-bold mb-4">Dati Cliente</h2>
        ...
        >
          <h2 className="text-xl font-bold mb-4 text-center">Ubicazione del Lavoro</h2>
        ...
        >
          <Button
            onClick={handleSave}
            size="lg"
            className="h-14 text-lg font-bold bg-sky-400 hover:bg-sky-500 text-white"
          >
            Salva
          </Button>
          <Button
